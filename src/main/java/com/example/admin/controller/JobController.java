...
import com.example.admin.data.JobInfo;
import com.example.admin.service.BaseJob;
import com.example.admin.service.IJobAndTriggerService;
import com.example.admin.util.DateUnit;
...
//            log.info(CC.LOG_PREFIX + "更新任务："+JasonUtils.Object2String(scheduleJob));
    ...
    public void triggerjob(@RequestParam(value = "jobClassName") String jobClassName, @RequestParam(value = "jobGroupName") String jobGroupName) throws Exception {
        jobtrigger(jobClassName, jobGroupName);
    }

    public void jobtrigger(String jobClassName, String jobGroupName) throws Exception {
